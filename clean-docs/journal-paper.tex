...
\centering
\includegraphics[width=0.95\linewidth]{Figures/icons/Abstract}
...
\item BLIP-2 contrastive-enhanced fine-tuning yields only a small gain in ScienceQA with BLIP-2 over generative fine-tuning, and the retrieval diagnostics are very close to frozen and random controls.
...
\begin{figure}[!htbp]
\centerline{\includegraphics[width=\linewidth,height=0.74\textheight,keepaspectratio]{./Figures/icons/ModelArchitecture.pdf}}
...
\begin{adjustbox}{max width=\textwidth,max totalheight=0.78\textheight,keepaspectratio}
...
The source code, experiment configurations, Colab pipeline, final figures, and LaTeX sources used in this study are available at \url{https://github.com/Kamran151199/thesis}.
The full paper-artifact workflow writes run logs, generated tables, masking examples, split/leakage audits, and claim-to-evidence files during execution.
Large checkpoints and downloaded datasets are not stored in the repository.
