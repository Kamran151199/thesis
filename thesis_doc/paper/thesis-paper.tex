...
In principle, this can motivate the model to learn stronger image--answer alignment.
...
Instead, we test the contrastive-enhanced setup directly against a BLIP-2 generative fine-tuning control, to check whether it actually leads to a stronger result.
