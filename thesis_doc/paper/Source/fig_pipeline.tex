...
\node[card,text width=3.55cm,minimum height=0.95cm] (c1) at (2.55,7.25)
  {\textbf{Backbone}\\[-1pt]\scriptsize Qwen2--VL 2B/7B, BLIP-2};
...
\node[card,text width=3.55cm,minimum height=0.95cm] (c3) at (10.45,7.25)
  {\textbf{Objective}\\[-1pt]\scriptsize zero-shot, answer-only, rationale CE, expl.-aware, contrastive};
...
\node[card,text width=3.2cm,minimum height=0.88cm] (s2) at (8.5,3.70)
  {\textbf{Task fine-tune}\\[-1pt]\scriptsize Qwen2--VL QLoRA or\\ BLIP-2 Q-Former path};
...
\node[metric,text width=3.3cm,minimum height=1.0cm] (m2) at (8.5,2.08)
  {\textbf{Explanation}\\[-1pt]\scriptsize ROUGE-L, BLEU\\[-1pt]\scriptsize only for rationale runs};
\node[metric,text width=3.3cm,minimum height=1.0cm] (m3) at (13.0,2.08)
  {\textbf{Evidence sensitivity}\\[-1pt]\scriptsize top / random / blank masks\\[-1pt]\scriptsize mask $\rightarrow$ answer drift};
